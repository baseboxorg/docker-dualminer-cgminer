...
RUN apt-get update && \
    ...
    #build-essential  autoconf libtool libcurl4-openssl-dev libncurses5-dev pkg-config yasm make libusb-1.0-0-dev libudev-dev libpthread-stubs0-dev make git nano screen && \
